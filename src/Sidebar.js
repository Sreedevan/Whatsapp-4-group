          ...
          <div className="siderbar__wrapper">
            ...
            <div className="sidebar__header">
              ...
              <p className="sidebar__greeting mobile__tag">
                {" "}
                <a
                  href="https://github.com/Sreedevan"
                  style={{ color: "white" }}
                >
                  whatsapp by <span style={{ color: "white" }}>Sreedevan</span>
                </a>
              </p>
        ...
        <div className={"sidebar"}>
          <div className="sidebar__header">
            ...
            <p className="sidebar__greeting">
              {" "}
              <a href="https://github.com/Sreedevan">
               whatsapp by <span style={{ color: "blue" }}>Sreedevan</span>
              </a>
            </p>
            <div className="sidebar__headerRight">
              <IconButton>
